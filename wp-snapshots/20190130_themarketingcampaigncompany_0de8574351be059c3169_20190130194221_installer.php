...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190130_themarketingcampaigncompany_0de8574351be059c3169_20190130194221_archive.zip';
	const ARCHIVE_SIZE		 = '18213759';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0de8574-30194221';
	const VERSION			 = '1.3.4';
